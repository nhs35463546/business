...
# 💡 [요청 반영] 사용자가 축의 의미를 쉽게 이해할 수 있도록 문구 배치
st.markdown("""
...
st.markdown("---")
# =========================================================================
# 5. [수정됨] 메인 시각화 1: 산점도 (요청하신 제목 반영 및 줌 한계 설정)
# =========================================================================
# 💡 사용자가 요청하신 직관적인 사분면 차트 제목으로 교체했습니다.
st.markdown("### 📍 업종별 위험(Risk) vs 규모(Size) 사분면 차트")
st.caption("빨간 점선 우측에 있을수록 코로나 위기를 잘 버틴 안전한 업종입니다. (마우스 스크롤로 확대/축소 가능)")
...
if not filtered_summary.empty:
    ...
    # 경고 및 가상 메모리 에러 해결을 위해 width='stretch' 변경 적용
...
# =========================================================================
# 6. 메인 시각화 2: 영역 차트 (Segmentation fault 완전 차단 유지)
# =========================================================================
st.markdown("### 📈 선택한 업종들의 10개년 창업 수 누적 변화 추이")
st.caption("선택된 세부 업종들이 지난 10년 동안 전체 시장에서 차지해 온 누적 크기를 비교합니다.")
