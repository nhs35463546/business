...
if corp_shock_2020 > priv_shock_2020:
    st.success("🛡️ '법인'이라는 형태가 위기를 막아주는 든든한 방패가 되었습니다!")
    st.markdown(f"""
    <div class="compare-card">
        <p style="color:#334155; line-height:1.8; font-size:16px;">
            2020년 위기 속에서 <b>법인 창업 변동률({corp_shock_2020}%)</b>이 <b>개인 창업 변동률({priv_shock_2020}%)</b>보다 
            수치상으로 더 높게 나타났습니다. 왜 이런 차이가 발생했을까요?
        </p>
...
# 개인이 수치가 더 높거나 같을 때
    ...
    st.warning("⚠️ 위기 속에서 오히려 '개인 창업'의 빠른 기동성이 빛났습니다!")
    st.markdown(f"""
    <div class="compare-card">
        <p style="color:#334155; line-height:1.8; font-size:16px;">
        ...
        <div class="insight-box">
            ...
            <p style="color:#475569; margin-top:5px; line-height:1.7;">
                ...
                반면, 개인 창업은 사장님 혼자서 시장 변화에 맞춰 <b>결정과 행동을 즉각적으로 바꿀 수 있는 기동성(Agility)</b>이 있어 위기를 더 잘 모면한 것으로 해석할 수 있습니다.
            </p>
        </div>
    </div>
    """, unsafe_allow_html=True)
